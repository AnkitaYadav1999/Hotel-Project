...
public class LogPanel extends javax.swing.JDialog {
    ...
    public LogPanel(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 //       populateFoodTable();
    ...
    private void initComponents() {
        ...
        dateCmbBx = new javax.swing.JComboBox();
        ...
        dateCmbBx.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(dateCmbBx, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void populateFoodTable(ResultSet result) {
        result = db.getAllOrder();
        table_food.setModel(DbUtils.resultSetToTableModel(result));
        db.flushAll();
    }
/*private void populateFoodCombobox() {
        dateCmbBx.removeAllItems();
        //String dateOrder;
        dateOrder = orderDb.getDate1();
        dateCmbBx.addItem("Select your food");
        for (FoodEntity entity : dateOrder) {
            dateCmbBx.addItem(entity.getName());
        }
    }
*/
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (das != -1) {
            result = db.getAllPaymentInfo(das);
            populateFoodTable(result);
        } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LogPanel dialog = new LogPanel(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox dateCmbBx;
